...
//    private GetCallback getCallback;
    ...
    public void getCarByID(String id) throws UnirestException {
       ...
       Unirest.get(BASE_URL + "cars/" + id).asJsonAsync(new GetCallback(getDelegate()));
    }

    // sends an asynchronous request to the server as described above
    public void getAllCars() throws UnirestException {
        /*TODO: Create an asynchronous GET-request*/
        Unirest.get(BASE_URL + "cars").asJsonAsync(new GetAllCarsCallback(getDelegate()));
    }
    ...
    public void updateCar(Car car) throws UnirestException {
        ...
        Unirest.put(BASE_URL + "cars").header("content-type", "application/json")
                .body(car.toJson()).asJsonAsync(new PutCallback(car, getDelegate()));
    }

    // sends an asynchronous request to the server as described above
    public void createNewCar(Car car) throws UnirestException {
        /*TODO: Create an asynchronous POST-request*/
        Unirest.post(BASE_URL + "cars").header("content-type", "application/json")
                .body(car.toJson()).asJsonAsync(new PostCallback(car, getDelegate()));
    }

    // sends an asynchronous request to the server as described above
    public void deleteCar(Car car) throws UnirestException {
        /*TODO: Create an asynchronous DELETE-request*/
        Unirest.delete(BASE_URL + "cars/" + car.getId()).header("content-type", "application/json")
                .body(car.toJson()).asJsonAsync(new DeleteCallback(car, getDelegate()));
    ...
    */
    public void getAllUserRentals() throws UnirestException {
        ...
        /*TODO: Create an asynchronous GET-request*/
        Unirest.get(BASE_URL).asJsonAsync(new GetMainURLCallback(delegate));
    }
}
